...
* Módulo...........: MM                                                     *
* Programa.........: ZFMM_SHDB_J_1BTXDEF                                    *
* Transação........:                                                        *
* Tipo de Prg......: FUNÇÃO                                                 *
* Objetivo.........: Criar taxas default                                    *
* Data.............: 25/09/2018                                             *
* --------------------------------------------------------------------------*
* Request    | Descrição                                                    *
* --------------------------------------------------------------------------*
...
FUNCTION zfmm_shdb_j_1btxdef.
*"----------------------------------------------------------------------
*"*"Interface local:
*"  IMPORTING
*"     REFERENCE(P_I_TI_J_1BTXDEF) TYPE  ZTMM_J_1BTXDEF
...
*-------------------------------------------------------------------*
*-------------------------------------------------------------------*
* Para cada taxa default
  LOOP AT p_i_ti_j_1btxdef INTO wa_j_1btxdef.
...
*---------------------------------------------------------------------*
    PERFORM: z_fill_bdc USING 'X' 'SAPLJ1BQ' '0005'
                        CHANGING ti_bdcdata,
             z_fill_bdc USING ' ' 'BDC_CURSOR' 'J_1BTXDEF-RATE(01)'
                        CHANGING ti_bdcdata,
...
*---------------------------------------------------------------------*
    PERFORM: z_fill_bdc USING 'X' 'SAPLJ1BQ' '0005'
             ...
             z_fill_bdc USING ' ' 'BDC_OKCODE' '/00'
                        CHANGING ti_bdcdata,
             z_fill_bdc USING ' ' 'J_1BTXDEF-TAX(01)'       wa_j_1btxdef-tax
                        CHANGING ti_bdcdata,
             z_fill_bdc USING ' ' 'J_1BTXDEF-VALIDFROM(01)' lc_validfrom
                        CHANGING ti_bdcdata,
             z_fill_bdc USING ' ' 'J_1BTXDEF-RATE(01)'      wa_j_1btxdef-rate
                        CHANGING ti_bdcdata.
